...
$(function(){
            ...
            case (viewport().width >= 1350 && viewport().width <= 1599):
                ...
                while (col_length != n) {
                    ...
                    couple.find("img").each(function() {
                        ...
                        img_number = $.inArray($(this).attr('src'), images) + 1;
    ...
    for (i = 0; i < $(".item.active img").length; i++) {
        ...
        img_number = $.inArray(img.attr('src'), images) + 1;
    ...
    right_arrow.click(function() {
        ...
        $('#myCarousel').on('slid.bs.carousel', function () {
            ...
            if (img_last_num + $(".item.active img").lenth + 1 > images.length) {
                right_arrow.addClass("hide");
            }
